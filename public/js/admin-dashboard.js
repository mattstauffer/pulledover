...
var _userUserJs = require('./user/user.js');

var _userUserJs2 = _interopRequireDefault(_userUserJs);
    ...
    ready: function ready() {
        ...
        users = users.map(function (user) {
            ...
            var recordings = user.recordings.map(function (rec) {
                rec.created_at = (0, _moment2['default'])(rec.created_at);
            ...
            user.recordingsThisMonth = recordings.filter(function (r) {
                return r.created_at.isAfter(_this.startOfMonth);
            });
...
},{"./dashboard.html":6,"./user/user.js":8,"lodash":2,"moment":3,"vue":5}],2:[function(require,module,exports){
(function (global){
/**
 * @license
