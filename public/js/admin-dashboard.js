...
new _vue2['default']({
    ...
    components: {
        user: _userJs2['default']
    },

    filters: {
        chunk: function chunk(items, count) {
...
},{"./user.js":6,"vue":3}],2:[function(require,module,exports){
...
module.exports = {
    ...
    methods: {
        selectRecording: function selectRecording(e) {
...
var _recordingsJs = require('./recordings.js');

var _recordingsJs2 = _interopRequireDefault(_recordingsJs);

var _phoneJs = require('./phone.js');

var _phoneJs2 = _interopRequireDefault(_phoneJs);

module.exports = {
    template: '#user-template',
    props: ['user', 'index'],
    components: {
        phone: _phoneJs2['default'],
        recordings: _recordingsJs2['default']
    },
    filters: {
        thisMonth: function thisMonth(arr) {}
    }
};

},{"./phone.js":4,"./recordings.js":5}]},{},[1]);
